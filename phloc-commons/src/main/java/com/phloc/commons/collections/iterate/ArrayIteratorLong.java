...
public final class ArrayIteratorLong
{
  ...
  public ArrayIteratorLong (@Nonnull final long... aArray)
  {
    this (aArray, 0, aArray.length);
  }

  public ArrayIteratorLong (@Nonnull final long [] aArray, @Nonnegative final int nBegin, @Nonnegative final int nEnd)
  {
    if (aArray == null)
