...
public class Constants
{
   ...
   */
  static public final String RELAXNG_COMPACT_URI = "http://www.iana.org/assignments/media-types/application/relax-ng-compact-syntax";

  /**
   * URI representating the Relax NG XML Syntax schema language. Identical to
