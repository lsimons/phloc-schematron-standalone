...
/**
 * Utility class. Stores a set of integers. The set is stored in an array and
 * sorted.
 */
class IntSet
{
   ...
   * 
   * @param is
   *        The other integer set.
   */
  void addAll (final IntSet is)
  {
    if (is.len == 0)
      return;
    final int [] newv = new int [len + is.len];
    int i = 0, j = 0, k = 0;
   ...
   * 
   * @param i
   *        The index in the set, zero based.
