...
public class Uri
{
  ...
  public static String resolve (final String base, final String uriReference)
  {
    if (!isAbsolute (uriReference) && base != null && isAbsolute (base))
    {
      try
      {
        final URI baseURI = new URI (UriEncoder.encode (base));
  ...
  /**
   * Tests whether a valid URI reference has a fragment identifier. It is
   * allowed to pass an invalid URI reference, but the result is not defined.
   * 
   * @param uri
   *        the URI reference to be tested, must not be null
   * @return true if the URI reference has a fragment identifier, false
   *         otherwise
   */
  ...
  /**
   * Tests whether a valid URI reference is absolute. It is allowed to pass an
   * invalid URI reference, but the result is not defined. It is also allowed to
   * pass a valid URI with leading and trailing whitespace.
   * 
   * @param uri
