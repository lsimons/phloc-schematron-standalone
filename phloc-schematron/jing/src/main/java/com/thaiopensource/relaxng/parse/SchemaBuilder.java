...
public interface SchemaBuilder <P, NC, L, EA, CL extends CommentList <L>, A extends Annotations <L, EA, CL>>
{
  ...
  P makeExternalRef (String href, String base, String ns, Scope <P, L, EA, CL, A> scope, L loc, A anno) throws BuildException,
                                                                                                       IllegalSchemaException;

  NC makeNameClassChoice (List <NC> nameClasses, L loc, A anno);

  // Compare against INHERIT_NS with == not equals.
  // Doing new String() ensures it is not == if the user specifies #inherit
  ...
  ElementAnnotationBuilder <L, EA, CL> makeElementAnnotationBuilder (String ns,
                                                                     String localName,
                                                                     String prefix,
                                                                     L loc,
                                                                     CL comments,
