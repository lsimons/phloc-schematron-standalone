...
public interface ISchematronResource extends IHasID <String>
{
   ...
   */
  @Nonnull
  EValidity getSchematronValidity (@Nonnull final IReadableResource aXMLResource) throws Exception;
   ...
   */
  @Nullable
  SchematronOutputType applySchematronValidationToSVRL (@Nonnull IReadableResource aXMLResource) throws Exception;
