...
{
  /**
   * Compiles a string containing a regular expression into a <code>Regex</code>
   * object. The <code>Regex</code> object can be used to test whether a string
   ...
   *         if <code>str</code> is not a valid regular expression
   */
