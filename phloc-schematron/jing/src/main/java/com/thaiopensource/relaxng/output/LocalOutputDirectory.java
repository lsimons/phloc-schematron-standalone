...
public class LocalOutputDirectory implements OutputDirectory
{
  ...
  public LocalOutputDirectory (final String mainSourceUri,
                               final File mainOutputFile,
                               ...
                               final int indent)
  {
    ...
    final int slashOff = mainSourceUri.lastIndexOf ('/');
    final int dotOff = mainSourceUri.lastIndexOf ('.');
  ...
  public OutputDirectory.Stream open (final String sourceUri, String encoding) throws IOException
  {
    if (encoding == null || alwaysUseDefaultEncoding)
      encoding = defaultEncoding;
    final String javaEncoding = EncodingMap.getJavaName (encoding);
    final File file = new File (mainOutputFile.getParentFile (), mapFilename (sourceUri));
  ...
  public String reference (final String fromSourceUri, final String toSourceUri)
  {
    return mapFilename (toSourceUri);
  }

  private String mapFilename (final String sourceUri)
  {
  ...
  private String chooseFilename (final String sourceUri)
  {
