 ...
 * http://www.brz.gv.at
 *
 * Copyright (C) 2012-2013 phloc systems
 * http://www.phloc.com
      ...
      for (final String sFilename : aFilenames)
      {
        ...
        else
        {
          ...
          try
          {
            ...
            final ErrorListener aMojoErrorListener = new AbstractTransformErrorListener ()
            {
              @Override
            ...
            if (aXsltProvider != null)
            {
              ...
              XMLWriter.writeToStream (aXsltProvider.getXSLTDocument (), FileUtils.getOutputStream (aXSLTFile));
            }
            else
            {
