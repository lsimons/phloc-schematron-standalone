...
/**
 * Thrown to indicate that the subarray being tokenized is not the complete
 * encoding of one or more XML characters, but might be if more chars were
 * added.
 */
public class PartialCharException extends PartialTokenException
{
  ...
  PartialCharException (final int leadCharIndex)
  {
