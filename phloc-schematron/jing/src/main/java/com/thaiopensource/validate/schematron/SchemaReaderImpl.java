...
class SchemaReaderImpl extends AbstractSchemaReader
{
  ...
  SchemaReaderImpl (final SAXTransformerFactory transformerFactory,
  ...
  {
    final String className = SchemaReaderImpl.class.getName ();
  ...
  {
    final ClassLoader cl = SchemaReaderImpl.class.getClassLoader ();
