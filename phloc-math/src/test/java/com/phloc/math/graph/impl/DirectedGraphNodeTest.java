...
public final class DirectedGraphNodeTest
{
  ...
  {
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (new DirectedGraphNode ("id0"),
                                                                    new DirectedGraphNode ("id0"));
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (new DirectedGraphNode ("id0"),
