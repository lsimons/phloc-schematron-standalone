...
public final class DirectedGraphRelationTest
{
  ...
  public void testGet ()
  {
    ...
    PhlocTestUtils.testDefaultImplementationWithEqualContentObject (new DirectedGraphRelation ("id1", nf, nt),
                                                                    new DirectedGraphRelation ("id1", nf, nt));
    // different IDs
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (new DirectedGraphRelation (nf, nt),
                                                                        new DirectedGraphRelation (nf, nt));
    PhlocTestUtils.testDefaultImplementationWithDifferentContentObject (new DirectedGraphRelation ("id1", nf, nt),
