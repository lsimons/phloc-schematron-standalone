...
public class RELAXEntityResolver extends SimpleEntityResolver
{
  ...
  {
    final String coreUri = getClass ().getResource ("/jp/gr/xml/relax/lib/relaxCore.dtd").toExternalForm ();
    final String nsUri = getClass ().getResource ("/jp/gr/xml/relax/lib/relaxNamespace.dtd").toExternalForm ();
    final String grammarUri = getClass ().getResource ("/jp/gr/xml/relax/lib/relax.dtd").toExternalForm ();
