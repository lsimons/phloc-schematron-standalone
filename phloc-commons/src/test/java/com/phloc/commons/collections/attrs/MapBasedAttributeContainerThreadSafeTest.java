...
public final class MapBasedAttributeContainerThreadSafeTest
{
  ...
  public void testInit ()
  {
    ...
    try
    {
      new MapBasedAttributeContainerThreadSafe ((Map <String, Object>) null);
      fail ();
    }
  ...
  {
    final MapBasedAttributeContainerThreadSafe aCont = new MapBasedAttributeContainerThreadSafe ();
    // Not yet present
