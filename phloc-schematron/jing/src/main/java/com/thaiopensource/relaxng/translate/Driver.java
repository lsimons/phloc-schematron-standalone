...
public class Driver
{
  ...
  public Driver (final ErrorHandlerImpl eh)
  {
    this.eh = eh;
  }
  ...
  {
    final List <String> inputParams = new ArrayList <String> ();
    final List <String> outputParams = new ArrayList <String> ();
    final List <String> catalogUris = new ArrayList <String> ();
    try
    {
      final OptionParser op = new OptionParser ("C:I:O:i:o:", args);
      try
      {
      ...
      final String [] inputParamArray = inputParams.toArray (new String [inputParams.size ()]);
      ...
      if (args.length > 2)
      {
        ...
        final String [] uris = new String [args.length - 1];
      ...
      final OutputDirectory od = new LocalOutputDirectory (sc.getMainUri (),
                                                           ...
                                                           DEFAULT_LINE_LENGTH,
                                                           DEFAULT_INDENT);
      outputFormat.output (sc,
                           od,
                           outputParams.toArray (new String [outputParams.size ()]),
  ...
  static private String extension (final String s)
  {
