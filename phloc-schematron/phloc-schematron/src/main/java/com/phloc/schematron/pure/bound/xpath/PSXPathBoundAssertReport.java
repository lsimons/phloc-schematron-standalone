...
public class PSXPathBoundAssertReport
{
  ...
  {
    if (aAssertReport == null)
      throw new NullPointerException ("AssertReport");
    if (sTestExpression == null)
      throw new NullPointerException ("TestExpression");
    if (aBoundTestExpression == null)
      throw new NullPointerException ("BoundTestExpression");
    if (aBoundContent == null)
      throw new NullPointerException ("BoundContent");
    if (aBoundDiagnostics == null)
      throw new NullPointerException ("BoundDiagnostics");
