...
/**
 * An extension to the Schema abstract class. The main difference is that there
 * is a default implementation of newValidator in terms of newValidatorHandler.
