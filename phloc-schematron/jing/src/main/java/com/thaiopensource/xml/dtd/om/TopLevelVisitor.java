...
public interface TopLevelVisitor
{
  ...
  void attributeGroupDef (String name, AttributeGroup attributeGroup) throws Exception;
  ...
  void externalIdRef (String name, ExternalId externalId, String uri, String encoding, TopLevel [] contents) throws Exception;
