 ...
 * <p>
 * This implementation can be used as a quick hack when the performance of
 * streaming validation is not important. And this implementation also shows you
 * how to implement the DatatypeStreamingValidator interface.
 * <p>
...
public final class StreamingValidatorImpl implements DatatypeStreamingValidator
{
  ...
  public void addCharacters (final char [] buf, final int start, final int len)
  {
