...
public class TestInferHandler
{
  ...
  public void testTypeInferenceForAttribute (final String xmlSource, final String type) throws SAXException,
                                                                                       IOException
  {
    final InferHandler handler = new InferHandler (new DatatypeLibraryFactoryImpl (new RegexEngineImpl ()));
