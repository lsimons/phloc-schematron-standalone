...
public class CompactSyntax <Pattern, NameClass, Location, ElementAnnotation, CommentListImpl extends CommentList <Location>, AnnotationsImpl extends Annotations <Location, ElementAnnotation, CommentListImpl>> implements
                                                                                                                                                                                                                 Context,
                                                                                                                                                                                                                 CompactSyntaxConstants
{
  ...
  public CompactSyntax (final Reader r,
                        final String sourceUri,
                        final SchemaBuilder <Pattern, NameClass, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> sb,
  ...
  Pattern parse (final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope) throws IllegalSchemaException
  {
    try
    {
      final Pattern p = Input (scope);
      if (!hadError)
        return p;
    }
    ...
    catch (final EscapeSyntaxException e)
    {
  ...
  Pattern parseInclude (final IncludedGrammar <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> g) throws IllegalSchemaException
  {
    try
    {
      final Pattern p = IncludedGrammar (g);
      if (!hadError)
        return p;
    }
    catch (final ParseException e)
  ...
  {
    final String result = namespaceMap.get (prefix);
  ...
  {
    final CommentListImpl tem = topLevelComments;
  ...
  private void topLevelComments (final GrammarSection <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section)
  {
  ...
  {
    final Token nextToken = getToken (1);
      ...
      do
      {
        ...
        if (t != null)
        {
          ...
          for (; t != null; t = t.next)
          {
            ...
            final Location loc = makeLocation (t);
            if (t.next != null && t.next.kind == CompactSyntaxConstants.SINGLE_LINE_COMMENT_CONTINUE)
            {
              ...
              } while (t.next != null && t.next.kind == CompactSyntaxConstants.SINGLE_LINE_COMMENT_CONTINUE);
              s = buf.toString ();
            }
  ...
  private Pattern afterPatternComments (final Pattern p)
  {
    final CommentListImpl comments = getComments (null);
    if (comments == null)
      return p;
    return sb.commentAfterPattern (p, comments);
  }

  private NameClass afterNameClassComments (final NameClass nc)
  {
    final CommentListImpl comments = getComments (null);
    if (comments == null)
      return nc;
  ...
  {
    final CommentListImpl comments = getComments ();
    if (comments == null)
      return null;
  ...
  private AnnotationsImpl addCommentsToLeadingAnnotations (final AnnotationsImpl a)
  {
    final CommentListImpl comments = getComments ();
    if (comments == null)
      return a;
  ...
  {
    final CommentListImpl comments = getTopLevelComments ();
    if (comments == null)
      return null;
    return sb.makeAnnotations (comments, getContext ());
  }
  ...
  private void addAttribute (final Annotations <Location, ElementAnnotation, CommentListImpl> a,
                             final String ns,
  ...
  {
    final String ns = namespaceMap.get (prefix);
    if (ns == null)
    {
  ...
  {
    final String ns = datatypesMap.get (prefix);
    if (ns == null)
    {
      error ("undeclared_prefix", prefix, t);
      return ""; // XXX
  ...
  final public Pattern Input (final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope) throws ParseException
  {
    Pattern p;
    Preamble ();
  ...
  final public Pattern IncludedGrammar (final IncludedGrammar <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> g) throws ParseException
  {
    AnnotationsImpl a;
    Pattern p;
    Preamble ();
  ...
  final public Pattern TopLevelGrammar (final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope) throws ParseException
  {
  ...
  final public void NamespaceDecl () throws ParseException
  {
    ...
    if (prefix != null)
    {
      if (prefix.getString ().equals ("xmlns"))
        ...
        if (prefix.getString ().equals ("xml"))
        {
  ...
  final public Pattern AnnotatedPrimaryExpr (final boolean topLevel,
                                             final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                             final Token [] except) throws ParseException
  {
    AnnotationsImpl a;
    Pattern p;
    ElementAnnotation e;
  ...
  final public Pattern PrimaryExpr (final boolean topLevel,
                                    final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                    final AnnotationsImpl a,
                                    final Token [] except) throws ParseException
  {
    Pattern p;
    switch ((jj_ntk == -1) ? jj_ntk () : jj_ntk)
  ...
  final public Pattern EmptyExpr (final AnnotationsImpl a) throws ParseException
  {
    Token t;
  ...
  final public Pattern TextExpr (final AnnotationsImpl a) throws ParseException
  {
    Token t;
  ...
  final public Pattern NotAllowedExpr (final AnnotationsImpl a) throws ParseException
  {
    Token t;
  ...
  final public Pattern Expr (final boolean topLevel,
                             final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                             Token t,
                             final AnnotationsImpl a) throws ParseException
  {
    Pattern p;
    final List <Pattern> patterns = new ArrayList <Pattern> ();
    final boolean [] hadOccur = new boolean [1];
    final Token [] except = new Token [1];
  ...
  final public Pattern UnaryExpr (final boolean topLevel,
                                  final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                  final boolean [] hadOccur,
                                  final Token [] except) throws ParseException
  {
    Pattern p;
    Token t;
      ...
      case 25:
        ...
        switch ((jj_ntk == -1) ? jj_ntk () : jj_ntk)
        {
          case 23:
            ...
            checkExcept (except);
            p = sb.makeOneOrMore (p, makeLocation (t), null);
            break;
          case 24:
            t = jj_consume_token (24);
            checkExcept (except);
            p = sb.makeOptional (p, makeLocation (t), null);
            break;
          case 25:
            t = jj_consume_token (25);
            checkExcept (except);
            p = sb.makeZeroOrMore (p, makeLocation (t), null);
            break;
          default:
            jj_la1[25] = jj_gen;
            jj_consume_token (-1);
  ...
  final public Pattern ElementExpr (final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                    final AnnotationsImpl a) throws ParseException
  {
    Token t;
    NameClass nc;
  ...
  final public Pattern AttributeExpr (final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                      final AnnotationsImpl a) throws ParseException
  {
    Token t;
    NameClass nc;
  ...
  final public NameClass NameClass (final int context, final Ref <AnnotationsImpl> ra) throws ParseException
  {
    AnnotationsImpl a;
    NameClass nc;
    a = AnnotationsImpl ();
  ...
  final public NameClass NameClassAlternatives (final int context, NameClass nc, final Ref <AnnotationsImpl> ra) throws ParseException
  {
    Token t;
  ...
  final public NameClass BasicNameClass (final int context) throws ParseException
  {
    AnnotationsImpl a;
    NameClass nc;
    a = AnnotationsImpl ();
  ...
  final public NameClass PrimaryNameClass (final int context, final AnnotationsImpl a) throws ParseException
  {
    NameClass nc;
    switch ((jj_ntk == -1) ? jj_ntk () : jj_ntk)
    {
  ...
  final public NameClass OpenNameClass (final int context, final AnnotationsImpl a) throws ParseException
  {
    Token t;
    LocatedString ns;
    switch ((jj_ntk == -1) ? jj_ntk () : jj_ntk)
    {
      case PREFIX_STAR:
        ...
        {
          if (true)
            return sb.makeNsName (ns.getString (), ns.getLocation (), a);
        }
        break;
      case 25:
        t = jj_consume_token (25);
        ...
        {
          if (true)
            return sb.makeAnyName (makeLocation (t), a);
        }
        break;
      default:
        jj_la1[34] = jj_gen;
  ...
  final public NameClass UnprefixedNameClass (final int context, final AnnotationsImpl a) throws ParseException
  {
    LocatedString name;
    name = UnprefixedName ();
    String ns;
  ...
  final public NameClass PrefixedNameClass (final AnnotationsImpl a) throws ParseException
  {
    Token t;
    t = jj_consume_token (PREFIXED_NAME);
    final String qn = t.image;
    final int colon = qn.indexOf (':');
  ...
  final public NameClass NsNameExceptClass (final int context, final AnnotationsImpl a, final Ref <AnnotationsImpl> ra) throws ParseException
  {
    LocatedString ns;
    NameClass nc;
    ns = NsName ();
  ...
  final public NameClass AnyNameExceptClass (final int context, final AnnotationsImpl a, final Ref <AnnotationsImpl> ra) throws ParseException
  {
    Token t;
    NameClass nc;
    t = jj_consume_token (25);
  ...
  final public NameClass ParenNameClass (final int context, final AnnotationsImpl a) throws ParseException
  {
    Token t;
    NameClass nc;
    final Ref <AnnotationsImpl> ra = new Ref <AnnotationsImpl> (a);
  ...
  final public NameClass ExceptNameClass (final int context) throws ParseException
  {
    NameClass nc;
    jj_consume_token (30);
    nc = BasicNameClass (context);
  ...
  final public Pattern ListExpr (final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                 final AnnotationsImpl a) throws ParseException
  {
    Token t;
    Pattern p;
  ...
  final public Pattern MixedExpr (final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                  final AnnotationsImpl a) throws ParseException
  {
    Token t;
    Pattern p;
  ...
  final public Pattern GrammarExpr (final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                    AnnotationsImpl a) throws ParseException
  {
    Token t;
    Grammar <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> g;
  ...
  final public Pattern ParenExpr (final boolean topLevel,
                                  final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                  final AnnotationsImpl a) throws ParseException
  {
    Token t;
  ...
  final public AnnotationsImpl GrammarBody (final GrammarSection <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section,
                                            final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                            AnnotationsImpl a) throws ParseException
  {
    ElementAnnotation e;
  ...
  final public void GrammarComponent (final GrammarSection <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section,
                                      final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope) throws ParseException
  {
    ElementAnnotation e;
    AnnotationsImpl a;
    a = AnnotationsImpl ();
  ...
  final public void Definition (final GrammarSection <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section,
                                final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                final AnnotationsImpl a) throws ParseException
  {
    switch ((jj_ntk == -1) ? jj_ntk () : jj_ntk)
  ...
  final public void Start (final GrammarSection <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section,
                           final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                           final AnnotationsImpl a) throws ParseException
  {
    Token t;
  ...
  final public void Define (final GrammarSection <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section,
                            final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                            final AnnotationsImpl a) throws ParseException
  {
    LocatedString name;
  ...
  final public void Include (final GrammarSection <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section,
                             final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                             AnnotationsImpl a) throws ParseException
  {
    Token t;
  ...
  final public AnnotationsImpl IncludeBody (final GrammarSection <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section,
                                            final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                            AnnotationsImpl a) throws ParseException
  {
    ElementAnnotation e;
  ...
  final public void IncludeComponent (final GrammarSection <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section,
                                      final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope) throws ParseException
  {
    ElementAnnotation e;
    AnnotationsImpl a;
  ...
  final public void Div (final GrammarSection <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section,
                         final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                         AnnotationsImpl a) throws ParseException
  {
    Token t;
    final Div <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> div = section.makeDiv ();
  ...
  final public void IncludeDiv (final GrammarSection <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> section,
                                final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                AnnotationsImpl a) throws ParseException
  {
    Token t;
  ...
  final public Pattern ExternalRefExpr (final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                        final AnnotationsImpl a) throws ParseException
  {
    Token t;
    String href;
  ...
  final public Pattern ParentExpr (final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                   AnnotationsImpl a) throws ParseException
  {
    LocatedString name;
    jj_consume_token (34);
  ...
  final public Pattern IdentifierExpr (final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                       final AnnotationsImpl a) throws ParseException
  {
    LocatedString name;
    name = Identifier ();
  ...
  final public Pattern ValueExpr (final boolean topLevel, AnnotationsImpl a) throws ParseException
  {
    LocatedString s;
    s = LocatedLiteral ();
  ...
  final public Pattern DataExpr (final boolean topLevel,
                                 final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                                 AnnotationsImpl a,
                                 final Token [] except) throws ParseException
  {
    ...
    final int colon = datatype.indexOf (':');
    if (colon < 0)
      datatypeUri = "";
    else
    {
  ...
  final public void Params (final DataPatternBuilder <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> dpb) throws ParseException
  {
    jj_consume_token (11);
    label_18: while (true)
    {
  ...
  final public void Param (final DataPatternBuilder <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> dpb) throws ParseException
  {
    LocatedString name;
    AnnotationsImpl a;
    String value;
  ...
  final public Pattern Except (final Scope <Pattern, Location, ElementAnnotation, CommentListImpl, AnnotationsImpl> scope,
                               final Token [] except) throws ParseException
  {
    AnnotationsImpl a;
    Pattern p;
    Token t;
    final Token [] innerExcept = new Token [1];
    ...
    switch ((jj_ntk == -1) ? jj_ntk () : jj_ntk)
    {
      case 1:
        ...
        if (a == null)
          a = sb.makeAnnotations (comments, getContext ());
        clearAttributeList ();
        annotationsIncludeElements = false;
        label_21: while (true)
        {
          if (jj_2_7 (2))
          {
        ...
        label_22: while (true)
        {
          ...
          e = AnnotationElement (false);
          a.addElement (e);
          annotationsIncludeElements = true;
        }
  ...
  final public void AnnotationAttribute (final Annotations <Location, ElementAnnotation, CommentListImpl> a) throws ParseException
  {
    switch ((jj_ntk == -1) ? jj_ntk () : jj_ntk)
    {
      case PREFIXED_NAME:
  ...
  final public void PrefixedAnnotationAttribute (final Annotations <Location, ElementAnnotation, CommentListImpl> a,
                                                 final boolean nested) throws ParseException
  {
    Token t;
    String value;
    t = jj_consume_token (PREFIXED_NAME);
    ...
    final String ns = lookupPrefix (prefix, t);
    if (ns == SchemaBuilder.INHERIT_NS)
      error ("inherited_annotation_namespace", t);
    else
      if (ns.length () == 0 && !nested)
        error ("unqualified_annotation_attribute", t);
      else
        if (ns.equals (WellKnownNamespaces.RELAX_NG) && !nested)
          error ("relax_ng_namespace", t);
        /*
         * else if (ns.length() == 0 && qn.length() - colon - 1 == 5 &&
  ...
  final public void UnprefixedAnnotationAttribute (final Annotations <Location, ElementAnnotation, CommentListImpl> a) throws ParseException
  {
    LocatedString name;
    String value;
    name = UnprefixedName ();
  ...
  final public ElementAnnotation AnnotationElement (final boolean nested) throws ParseException
  {
    ElementAnnotation a;
    switch ((jj_ntk == -1) ? jj_ntk () : jj_ntk)
    {
  ...
  final public ElementAnnotation PrefixedAnnotationElement (final boolean nested) throws ParseException
  {
    final CommentListImpl comments = getComments ();
    Token t;
    ElementAnnotationBuilder <Location, ElementAnnotation, CommentListImpl> eab;
    ...
    if (ns == SchemaBuilder.INHERIT_NS)
    {
      ...
      if (!nested && ns.equals (WellKnownNamespaces.RELAX_NG))
      {
        error ("relax_ng_namespace", t);
        ns = "";
      }
    ...
    eab = sb.makeElementAnnotationBuilder (ns,
                                           qn.substring (colon + 1),
                                           prefix,
                                           makeLocation (t),
                                           comments,
                                           getContext ());
  ...
  final public ElementAnnotation UnprefixedAnnotationElement () throws ParseException
  {
    ...
    ElementAnnotationBuilder <Location, ElementAnnotation, CommentListImpl> eab;
    name = UnprefixedName ();
    eab = sb.makeElementAnnotationBuilder ("", name.getString (), null, name.getLocation (), comments, getContext ());
    AnnotationElementContent (eab);
    {
      if (true)
        return eab.makeElementAnnotation ();
  ...
  final public void AnnotationElementContent (final ElementAnnotationBuilder <Location, ElementAnnotation, CommentListImpl> eab) throws ParseException
  {
    ElementAnnotation e;
    jj_consume_token (1);
    clearAttributeList ();
  ...
  final public void AnnotationElementLiteral (final ElementAnnotationBuilder <Location, ElementAnnotation, CommentListImpl> eab) throws ParseException
  {
    Token t;
    final CommentListImpl comments = getComments ();
  ...
  {
    if (jj_scan_token (PREFIXED_NAME))
      return true;
    if (jj_scan_token (2))
      return true;
    return false;
  ...
  {
    if (jj_scan_token (ESCAPED_IDENTIFIER))
      return true;
    return false;
  }
  ...
  public CompactSyntax (final java.io.InputStream stream)
  {
    this (stream, null);
  }

  /** Constructor with InputStream and supplied encoding */
  public CompactSyntax (final java.io.InputStream stream, final String encoding)
  {
    try
    {
  ...
  /** Constructor. */
  public CompactSyntax (final java.io.Reader stream)
  {
