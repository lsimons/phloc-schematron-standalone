...
class ContentType
{
  ...
  private ContentType (final ContentType parent)
  {
    this.parent = parent;
  }

  boolean isA (final ContentType t)
  {
    if (this == t)
      return true;
  ...
  static ContentType zeroOrMore (final ContentType t)
  {
  ...
  static ContentType oneOrMore (final ContentType t)
  {
    if (t == ERROR)
      return ERROR;
    if (t == EMPTY)
  ...
  static ContentType group (final ContentType t1, final ContentType t2)
  {
  ...
  static ContentType mixed (final ContentType t)
  {
    if (t.isA (EMPTY))
      return TEXT;
  ...
  static ContentType interleave (final ContentType t1, final ContentType t2)
  {
    ...
    if (((t1.isA (MIXED_MODEL) || t1 == TEXT) && t2.isA (ZERO_OR_MORE_ELEMENT_CLASS)) ||
        ...
        (t2.isA (MIXED_MODEL) || t2 == TEXT))
      return INTERLEAVE_MIXED_MODEL;
    return groupOrInterleave (t1, t2);
  }

  static private ContentType groupOrInterleave (final ContentType t1, final ContentType t2)
  {
  ...
  static ContentType optional (final ContentType t)
  {
    if (t == ERROR)
      return ERROR;
    if (t == EMPTY)
  ...
  static ContentType choice (final ContentType t1, final ContentType t2)
  {
    if (t1 == ERROR || t2 == ERROR)
      return ERROR;
  ...
  static ContentType ref (final ContentType t)
  {
