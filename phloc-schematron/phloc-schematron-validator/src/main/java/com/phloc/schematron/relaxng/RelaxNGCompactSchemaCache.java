 ...
 */
package com.phloc.schematron.relaxng;
...
import com.phloc.commons.xml.schema.DefaultSchemaCache;
 ...
 */
@ThreadSafe
public class RelaxNGCompactSchemaCache extends DefaultSchemaCache
{
  static
  {
  ...
  {
    static final RelaxNGCompactSchemaCache s_aInstance = new RelaxNGCompactSchemaCache (LoggingSAXErrorHandler.getInstance (),
